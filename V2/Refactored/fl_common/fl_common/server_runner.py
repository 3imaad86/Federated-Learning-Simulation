...
def run_federated_training(
    ...
    for r in range(1, num_rounds + 1):
        ...
        # 3) Recup metriques compute/comm depuis le callback agg_train
        ...
        print(f"[round {r}] acc={ev['accuracy']:.3f} loss={ev['loss']:.3f} "
              ...
              f"E={tr['mean_epochs']:.2f} tier={tr['mean_tier']:.2f}{tail}")
