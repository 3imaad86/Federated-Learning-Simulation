...
def train(msg: Message, context: Context):
    ...
    # IMPORTANT : momentum=0 (vanilla SGD). FedNova divise par tau_i en supposant
    # que Delta_i ≈ tau_i * lr * grad_moyen. Avec momentum, cette hypothese est
    # fausse (le momentum buffer accumule les gradients) -> rescaling incorrect.
    t0 = time.perf_counter()
    train_loss, tau_i = train_fn(model, trainloader, epochs, lr, device, momentum=0.0)
