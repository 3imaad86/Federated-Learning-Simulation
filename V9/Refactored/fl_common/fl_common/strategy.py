...
# ============================================================================
# 3) Estimation initiale de tau_eff (juste pour affichage du banner)
# ============================================================================

def compute_tau_eff_estimate(num_clients, epochs, batch, partitioning, alpha, seed=42):
    """tau_eff approx au demarrage. Le vrai est recalcule a chaque round."""
    from .data import partition_sizes
    sizes = partition_sizes(num_clients, partitioning=partitioning, alpha=alpha, seed=seed)
    # tau_i = epochs * ceil(n_i / batch)  (nb de pas SGD locaux)
