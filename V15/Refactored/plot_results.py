"""Plots de comparaison FedAvg / FedProx / FedNova / FedSGD / SCAFFOLD / q-FedAvg / FairFed.
...
Usage :
    ...
    python plot_results.py fedavg qfedavg fairfed   # uniquement ceux listes
"""
...
ALGOS = ["fedavg", "fedprox", "fednova", "fedsgd", "scaffold", "qfedavg", "fairfed"]
