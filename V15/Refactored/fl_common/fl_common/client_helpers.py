...
def compute_tier_epochs(pid, base_epochs, epochs_hetero):
    ...
    Ratio par defaut 6x = compromis entre :
    - Effet FedNova visible (besoin de heterogeneite)
    - Stabilite numerique (eviter divergence avec momentum)

    Pour un ratio plus extreme (15x), utiliser uniquement avec momentum=0.0
    et de petites partitions (10+ clients).
    """
