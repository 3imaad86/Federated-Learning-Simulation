"""Plots de comparaison FedAvg / FedProx / FedNova / FedSGD / SCAFFOLD.
...
Usage :
    ...
    python plot_results.py fedavg fednova scaffold  # uniquement ceux listes
"""
...
ALGOS = ["fedavg", "fedprox", "fednova", "fedsgd", "scaffold"]
